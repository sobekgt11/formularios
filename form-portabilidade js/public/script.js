document.addEventListener("DOMContentLoaded", function() {
    ...
    async function fetchConfig() {
        ...
        apiPythonUrl = config.apiPythonUrl;
    }
    
    async function submitForm() {
        await fetchConfig();
    
        const form = document.getElementById('portabilidadeForm'); // Use o ID correto do formulário
        const formData = new FormData(form);
        console.log("formData", formData)
        // Converte FormData para um objeto
        const formObject = {};
        formData.forEach((value, key) => {
            if (key !== "fundo[]" && key !== "montante[]" && key !== "quantidadeCotas[]") {
            ...
            if (key === "montante[]" || key === "quantidadeCotas[]") {
        ...
        const formObjectAdjusted = {
            ...
            nomeCessionario: formObject.nomeCessionario.toLowerCase() === "outro" ? formObject.nomeCessionarioOutro : formObject.nomeCessionario,
        ...
        console.log('Form Data:', formObjectAdjusted); // Log para depuração
    
        const response = await fetch(`${apiPythonUrl}/update-form-data`, {
            method: 'POST',
            headers: {
    ...
    async function enviarFormulario(event) {
        ...
        const form = document.getElementById('portabilidadeForm'); // Use o ID do formulário
        ...
        if (firstInvalidField) {
            ...
            const formData = new FormData(form);
            console.log("Dados do Formulário Form:", form);
